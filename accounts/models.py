...
class UserManager(BaseUserManager):
    ...
    def _create_user(self, id, email, password=None, **extra_fields):
        """
...
class User(AbstractBaseUser):
    ...
    city = models.CharField(_('ville'), max_length=255, blank=True)
    country_code = models.CharField(_('code pays'), max_length=2, blank=True)
